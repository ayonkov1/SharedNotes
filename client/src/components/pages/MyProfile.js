...
const MyProfile = ({
  Question: { title, description, UserQuestions, TotalLikes },
  User: { LoggedInUser },
  LogOut,
  setQuestion,
  addQuestion,
    ...
    <Fragment>
      ...
      <div>
        <div class='page-content p-5' id='content'>
          <div class='px-4 pt-0 pb-4 pt-4 mb-4 bg-dark profile-header-opacity rounded'>
            <div class='media align-items-end profile-header'>
              ...
              <div class='media-body mb-4 ml-2 text-white'>
                ...
                <p class='small mb-4'>
                  {' '}
                  <i class='fa fa-map-marker mr-2'></i>Eindhoven
                </p>
              ...
              <div class='p-4 d-flex justify-content-end text-center text-white'>
                <ul class='list-inline mb-0'>
                  <li class='list-inline-item'>
                    <h5 class='font-weight-bold mb-0 d-block'>{TotalLikes}</h5>
                    <small class='text-muted'>
                      {' '}
                      <i class='fa fa-picture-o mr-1'></i>Likes
                    </small>
                  </li>
                  <li class='list-inline-item'>
                    ...
                    <small class='text-muted'>
                      {' '}
                      <i class='fa fa-user-circle-o mr-1'></i>Questions
                    </small>
                  </li>
                </ul>
              </div>
          ...
          <Popup
            trigger={
              <button className='btn btn-primary btn-lg ' id='newQuestion'>
          ...
          >
            {(close) => (
              <Fragment>
                <span>
                  <div class='bg-white shadow rounded overflow-hidden px-4 mt-2'>
